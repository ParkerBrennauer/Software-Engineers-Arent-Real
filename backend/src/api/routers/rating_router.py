...
@router.post(
    "/{order_id}/rating", response_model=RatingResponse, status_code=status.HTTP_200_OK
)
...
@router.post(
    "/{order_id}/review", response_model=ReviewResponse, status_code=status.HTTP_200_OK
)
...
@router.delete(
    "/{order_id}/review", response_model=DeleteResponse, status_code=status.HTTP_200_OK
)
...
async def filter_reviews(
    restaurant_id: int, stars: int | None = Query(None, ge=1, le=5)
):
    try:
...
@router.post(
    "/{order_id}/report", response_model=ReportResponse, status_code=status.HTTP_200_OK
)
