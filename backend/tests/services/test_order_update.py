...
async def test_update_order_success():
    existing_order = {'id': 5, 'order_status': 'payment pending', 'payment_status': 'pending', 'items': [{'id': 1, 'price': 10.0}], 'cost': 10.0, 'locked': False}
    update_data = {'items': [{'id': 1, 'price': 10.0}, {'id': 2, 'price': 5.0}]}
    captured = {}
...
async def test_update_order_delivery_instructions():
    existing_order = {'id': 5, 'order_status': 'payment pending', 'payment_status': 'pending', 'items': [], 'cost': 0.0, 'locked': False}
