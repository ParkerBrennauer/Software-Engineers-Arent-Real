...
async def test_login_user_success_restaurant_owner(monkeypatch):
    user_data = {'id': 3, 'username': 'owner1', 'email': 'owner@example.com', 'name': 'Bob Owner', 'role': 'owner', 'hashed_password': '$2b$12$abcdefghijklmnopqrstuvwxyz', 'is_active': True, 'requires_2fa': True}
...
async def test_login_user_success_restaurant_staff(monkeypatch):
    user_data = {'id': 4, 'username': 'staff1', 'email': 'staff@example.com', 'name': 'Alice Staff', 'role': 'staff', 'hashed_password': '$2b$12$abcdefghijklmnopqrstuvwxyz', 'is_active': True, 'requires_2fa': True}
...
async def test_login_user_inactive_account(monkeypatch):
    user_data = {'id': 1, 'username': 'driver1', 'email': 'driver@example.com', 'name': 'John Driver', 'role': 'driver', 'hashed_password': '$2b$12$abcdefghijklmnopqrstuvwxyz', 'is_active': False, 'requires_2fa': True}
...
async def test_login_user_missing_hashed_password(monkeypatch):
    user_data = {'id': 1, 'username': 'driver1', 'email': 'driver@example.com', 'name': 'John Driver', 'role': 'driver', 'is_active': True, 'requires_2fa': True}
