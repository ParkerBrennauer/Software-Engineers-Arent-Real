...
async def test_get_restaurant_orders_success_owner(client, monkeypatch):
    ...
    response = client.get(
        "/restaurant_administration/restaurants/10/orders?username=owner1"
    )
...
async def test_get_restaurant_orders_success_staff(client, monkeypatch):
    ...
    response = client.get(
        "/restaurant_administration/restaurants/10/orders?username=staff1"
    )
...
async def test_get_restaurant_orders_permission_denied(client, monkeypatch):
    ...
    response = client.get(
        "/restaurant_administration/restaurants/10/orders?username=customer1"
    )
...
async def test_get_restaurant_orders_user_not_found(client, monkeypatch):
    ...
    response = client.get(
        "/restaurant_administration/restaurants/10/orders?username=nonexistent"
    )
...
async def test_get_restaurant_orders_restaurant_not_found(client, monkeypatch):
    ...
    response = client.get(
        "/restaurant_administration/restaurants/999/orders?username=owner1"
    )
